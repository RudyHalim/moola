...
--
-- Host: localhost
-- Generation Time: Jun 12, 2016 at 02:08 PM
...
INSERT INTO `tbl_configs` (`config_id`, `servicecharge_currency`, `servicecharge_value`) VALUES
(1, 'SGD', '1.25');
...
CREATE TABLE `tbl_countries` (
  ...
  `markup_value` decimal(9,2) NOT NULL COMMENT 'markup for each currency code'
...
INSERT INTO `tbl_countries` (`country_id`, `country_name`, `country_currency`, `country_trade`, `markup_value`) VALUES
...
INSERT INTO `tbl_order_status` (`orderstatus_id`, `orderstatus_name`) VALUES
(1, 'pending'),
(2, 'processing'),
(3, 'completed');
...
INSERT INTO `tbl_users` (`user_id`, `email_addr`, `passwd`, `first_name`, `last_name`, `gender`, `phone_no`, `display_image`, `country_id`, `role_id`) VALUES
...
--
ALTER TABLE `tbl_countries`
  MODIFY `country_id` int(3) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
